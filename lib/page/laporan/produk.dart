...
import 'package:aplikasi/functions/barang/laporan/print.dart';
...
class _ProdukViewState extends State<ProdukView> {
          ...
          FutureBuilder(
              ...
              builder: (BuildContext ctx, AsyncSnapshot<List<Barang>?> snpsht) {
                if (snpsht.connectionState == ConnectionState.done &&
                  ...
                  snpsht.data!.forEach((x) {
                    jumlahStokSkrg = jumlahStokSkrg + x.jumlahStok!;
                  });
  ...
  Future<List<LaporanDataBarang>?> packingLaporanBarang() async {
    List<StokKeluarBarang>? dataKeluarBarang =
        await fetchLaporanKeluarStokBarang();
    List<StokMasukBarang>? dataMasukBarang =
        await fetchLaporanMasukStokBarang();
                      ...
                      children: [
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              FilterChip(
                                  label: const Text("hanya barang masuk"),
                                  selected: mode == Mode.masukonly,
                                  onSelected: (val) =>
                                      setState(() => mode = Mode.masukonly)),
                              FilterChip(
                                  label: const Text("Hanya barang keluar"),
  ...
  Future<List<LaporanDataBarang>?> fetchedNerarlyExpired() async {
    List<StokMasukBarang>? dataMasukBarang =
        await fetchLaporanMasukStokBarang();
    ...
    List<LaporanDataBarang> nearlyExpired = finaldata.where((x) {
                ...
                if (snpsht.data != null) {
                  ...
                  return Column(
                      ...
                      children: [
                        ...
                        const Text(
                            'Berikut merupakan daftar stok barang yang akan kadaluarsa dalam seminggu'),
                        const SizedBox(height: 15),
                        Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
  ...
  Future<List<LaporanDataBarang>?> fetchedHasyExpired() async {
    List<StokMasukBarang>? dataMasukBarang =
        await fetchLaporanMasukStokBarang();
